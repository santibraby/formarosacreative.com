...
#
# One line per guide (9 parts separated by | ):
#   guide-id | Title | One-line pitch | page link | cover image url | What's-inside intro | Item one; Item two; Item three | zip/pdf url | email subject
#
