...
#
# One line per guide (8 parts separated by | ):
#   guide-id | Title | One-line pitch | page link | cover image url | What's-inside intro | Item one; Item two; Item three | zip/pdf url
#
# - zip/pdf url = the same file as in frc_sub_magnets() - powers
#   the "grab the zip right now" link on the thank-you page.
#
