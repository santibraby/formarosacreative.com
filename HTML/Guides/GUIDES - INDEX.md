...
#
# One line per guide (5 parts separated by | ):
#   guide-id | Title | One-line pitch | page link | cover image url
#
...
texture-maps | Right-Click an Image to Generate Texture Maps | EDIT ME - one line on what is inside the zip and why it is useful | /guides/generate-texture-maps/ | https://formarosacreative.com/wp-content/uploads/2026/08/TextureMaps-Poster-1.jpg
