...
![HDR WEXNER MEDICAL CENTER](https://formarosacreative.com/wp-content/uploads/2025/06/ohio-state-university-wexner-medical-center-new-hospital-tower-drone-connection-james-cancer-center-d1400-975.jpg.webp "HDR's OSU Wexner Medical Center - New Hospital Tower")

My career really started at HDR and I was on the design team doing architecture, doing kind of anything and everything. We designed the hospital tower's building shape, we designed the garage, we designed the floor plans, we designed the facade, we modeled the whole thing in sketchup, then rhino then revit as we moved from concept, to design development to construction documents. And as we got closer to construction on the OSU Medical Center, we started developing a new ad-package the patient experience.

![OSU WEXNER MEDICAL CENTER](https://formarosacreative.com/wp-content/uploads/2025/06/83150695007-04172025-wex-tower-skm-3.webp "HDR's OSU Wexner Medical Center - Patient Experience")

We developed the entrance sequence for how the patient's enter the hospital. The kiosk that greets you when you enter, a big feature wall with the branding. A coffee bar that sat underneath the escalator as well as an auditorium, a meditation space, and a kind of tranquil garden that sat at the backside of the building. So right away from this big design company, I narrowed my vision into a more intimate and - close to the guest experience - architectural study.

But I still felt disconnected from the actual building of architecture and I felt like I didn't understand it completely. I had just gotten out of school. I didn't understand completely how things were built and I wanted to understand how my designs were being constructed and fabricated.

## Facade Fabrication

![ISLAND FACADES](https://formarosacreative.com/wp-content/uploads/2025/06/660Install_2500x1667_CameronBlaylock_DSC00830.jpg "Island Facades - 660 5th Ave")

So I switched paths and I went to work at Island Facades as a facade designer. This was a really great experience because it coincided with COVID-19 and I working remotely (traveling Europe) and working on pretty intricate and complex design problems at an engineering firm. I definitely found a better understanding of the technical details and what it takes to build a building. And furthermore, I gained a real insight into how projects come together. It's not just about putting together design package, it's about coordinating with project managers. It's about coordinating with contractors and builders and architects and interior designers and glass fabricators and aluminum suppliers. And the ecosystem is quite a bit bigger than just designers. Which to me was new. I had been working at large architecture studio. 30 people, all designers.
...
And as I got deeper and deeper into luxury residential architecture, while it was fulfilling and I was learning a lot about putting together projects and seeing them come together, which is something that I never got when I was working at HDR, I was still feeling disconnected from really concept forward projects that I was able to do with our own studio during our exhibitions and installations.
